...
// Получение направлений бакалавриата
try {
    $stmt = $pdo->query("SELECT id, name FROM directions WHERE type = 'bachelor'");
...
<head>
    ...
    <title>Бакалавриат - Система управления силлабусами</title>
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="bachelor.php">Бакалавр</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container">
        <h2 class="text-center mb-4" style="color: #005B99;">Направления бакалавриата</h2>
        <?php if (isset($error)): ?>
            <div class="alert alert-danger"><?php echo htmlspecialchars($error); ?></div>
        <?php else: ?>
            <?php if (empty($directions)): ?>
                <div class="alert alert-info">Направления бакалавриата отсутствуют.</div>
            <?php else: ?>
